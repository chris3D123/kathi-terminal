...
def input_box(prompt):
    ...
    tk.Label(temp_window, text=prompt).pack()
    temp_var = tk.StringVar()
    temp_entry = tk.Entry(temp_window, textvariable=temp_var)
    temp_entry.pack()
    temp_entry.focus()
    tk.Button(temp_window, text="Submit", command=temp_window.destroy).pack()
