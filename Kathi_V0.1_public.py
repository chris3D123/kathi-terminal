...
def display_help():
    terminal_output.insert(tk.END, "h  = help\n")
    terminal_output.insert(tk.END, "NF = new file\n")
    terminal_output.insert(tk.END, "RF  = run a file\n")
...
def execute_command():
    ...
    if command == "exit":
        ...
        terminal_output.insert(tk.END, "Invalid command. Type 'help' for help.\n")
        terminal_output.yview(tk.END)
...
root = tk.Tk()
root.title("KATHI Admin Terminal V0.1 public")
...
terminal_output.insert(tk.END, "Welcome to KATHI Terminal! Type 'help' for help.\n")
terminal_output.yview(tk.END)
root.mainloop()